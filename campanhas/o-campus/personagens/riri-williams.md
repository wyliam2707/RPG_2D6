...
## Poderes / Recursos
- **Armadura Ironheart:** permite voo, força aumentada, proteção, suporte vital básico e operação em ambientes hostis.
- **Repulsores:** permitem ataques de energia à distância e impulsos de movimento.
- **Sensores Avançados:** permitem detectar assinaturas energéticas, movimento, calor, composição e anomalias tecnológicas dentro dos limites da armadura.
- **Interface Tática:** integra leitura de campo, alvos, trajetórias e informações da armadura durante combate.
- **Engenharia de Campo:** recurso pessoal que permite diagnosticar, reparar, adaptar ou construir tecnologia compatível quando houver tempo, materiais e ferramentas adequadas.
